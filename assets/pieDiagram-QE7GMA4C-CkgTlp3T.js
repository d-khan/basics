import{p as U}from"./chunk-K2ZEYYM2-DcTz3GDI.js";import{p as H}from"./treemap-KMMF4GRG-5JCI3IDA-BxhEJuTr.js";import{a as s,g as K,s as Q,b as V,c as Z,x as j,v as q,l as w,d as J,H as X,aO as Y,aQ as ee,aR as G,aS as te,f as ae,B as re,aT as ie,K as se}from"./Mermaid.vue_vue_type_script_setup_true_lang-Bvd7R_bp.js";import"./chunk-TGZYFRKZ-DOduY5CY.js";import"./monaco/bundled-types-D4l7l70H.js";import"./modules/file-saver-C8QSpN-3.js";import"./modules/vue-DKUtoFQI.js";import"./lz-string-si4yBCUE.js";import"./index-CJ-Ue-1K.js";import"./modules/shiki-BeL4CYbJ.js";var le=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,oe=structuredClone(le),ne=s(()=>structuredClone(oe),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),O={getConfig:ne,clear:ce,setDiagramTitle:q,getDiagramTitle:j,setAccTitle:Z,getAccTitle:V,setAccDescription:Q,getAccDescription:K,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),me={parse:s(async e=>{const a=await H("pie",e);w.debug(a),fe(a,O)},"parse")},he=s(e=>`
  .pieCircle{
